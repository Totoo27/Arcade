...
public class GamePanel extends JPanel implements ActionListener, KeyListener {
    ...
    protected void paintComponent(Graphics g) {
        ...
        if(player != null) {
        	...
        	for(int i = 0; i<player.vida; i++) {
        		g.drawImage(
                		new ImageIcon("src/sprites/barravida.png").getImage(),
                        coordX,
                        20,
                        40,
                        39,
        ...
        g.drawImage(
        		new ImageIcon("src/sprites/coin.png").getImage(),
                60,
                80,
                37,
                30,
    ...
    public void keyPressed(KeyEvent e) {
        ...
        if (e.getKeyCode() == KeyEvent.VK_SHIFT) player.disparo = true;
    }
    ...
    public void keyReleased(KeyEvent e) {
        ...
        if (e.getKeyCode() == KeyEvent.VK_SHIFT) player.disparo = false;
    }
